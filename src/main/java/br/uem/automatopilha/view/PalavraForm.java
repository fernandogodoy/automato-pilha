 ...
 * @author Fernando
 */
public class PalavraForm extends javax.swing.JDialog {

	private static final long serialVersionUID = 1L;
	private final JLabel label;

    public PalavraForm(JLabel label) {
        initComponents();
        this.setModal(true);
        this.label = label;
        ...
        this.setSize(new Dimension(581, 120));
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Insert your word:");

        tfWord.setColumns(40);
